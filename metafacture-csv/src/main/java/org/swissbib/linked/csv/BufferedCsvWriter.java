...
public class BufferedCsvWriter {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(BufferedCsvWriter.class);
    ...
    public BufferedCsvWriter(String filename, String csvDir, int csvFileLength, int batchWriteSize) {
